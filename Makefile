...
libPOLIMIControl.so:
	...
	$(CCC) -shared -Wl,-soname,libPOLIMIControl.so -o libPOLIMIControl.so FIR_filter.o discrete_tf.o discrete_ss.o continuous_ss.o differentiator.o PID_controller.o AGS_controller.o matfile_fun.o
